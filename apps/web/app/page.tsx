...
// Root homepage - Client component (workaround for Next.js 15.5 clientReferenceManifest bug)
// CRITICAL FIX: Making this a client component resolves the RSC manifest error
// All child components already have 'use client' so this is safe
import {
  Zap,
  Home,
  TrendingUp,
