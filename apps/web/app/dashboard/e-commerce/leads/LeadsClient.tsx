...
function LeadsClient({ ownerUid, isAuthLoading = false, user }: LeadsClientProps) {
  ...
  return (
    <main className={`min-h-screen bg-gray-50 dark:bg-[#0E1A2B] ${language === 'he' ? 'rtl' : 'ltr'}`}>
      ...
      {showFilters && (
        <UniversalCard variant="default" className="mb-0 rounded-none border-x-0 animate-slide-up">
        ...
        {loading ? (
          ...
          <>
            ...
            {selectedLeads.size > 0 && (
              <UniversalCard variant="default" className="mb-6 animate-slide-up">
            ...
            {/* Table View */}
            {viewMode === 'table' && (
              <UniversalCard variant="default" className="animate-fade-in">
                  ...
                  <UniversalTable>
                    ...
                    {filteredAndSortedLeads.map((lead, index) => (
                      ...
                      >
                        ...
                        <UniversalTableCell>
                          <div>
                            <span className="text-sm text-gray-900 dark:text-white">{SOURCE_LABELS[lead.source]}</span>
                            {lead.sourceName && (
                              <div className="text-xs text-gray-400 dark:text-gray-500">{lead.sourceName}</div>
                            )}
                        ...
                        <UniversalTableCell>
                          <div>
                            {lead.campaign ? (
                              <div>
                                <div className="font-medium text-gray-900 dark:text-white text-sm">{lead.campaign.name}</div>
                            ...
                            {lead.platformAdSetId && (
                              <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">AdSet: {lead.platformAdSetId}</div>
                            )}
                          </div>
                        </UniversalTableCell>
                        <UniversalTableCell>
            ...
            {/* Enhanced Pagination */}
            {totalPages > 1 && (
              <UniversalCard variant="default" className="mt-6 animate-fade-in">
