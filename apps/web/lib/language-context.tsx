...
const translations = {
  en: {
    ...
    // E-commerce Section
    // Dashboard
    'ecommerce.dashboard.title': 'E-commerce Dashboard',
    'ecommerce.dashboard.overview': 'Overview',
    'ecommerce.dashboard.totalLeads': 'Total Leads',
    'ecommerce.dashboard.activeLeads': 'Active Leads',
    'ecommerce.dashboard.convertedLeads': 'Converted Leads',
    'ecommerce.dashboard.conversionRate': 'Conversion Rate',
    'ecommerce.dashboard.totalCampaigns': 'Total Campaigns',
    'ecommerce.dashboard.activeCampaigns': 'Active Campaigns',
    'ecommerce.dashboard.campaignPerformance': 'Campaign Performance',
    'ecommerce.dashboard.recentLeads': 'Recent Leads',
    'ecommerce.dashboard.topCampaigns': 'Top Campaigns',
    'ecommerce.dashboard.quickActions': 'Quick Actions',
    'ecommerce.dashboard.createLead': 'Create New Lead',
    'ecommerce.dashboard.importCSV': 'Import CSV',
    'ecommerce.dashboard.newCampaign': 'New Campaign',
    'ecommerce.dashboard.viewReports': 'View Reports',

    // Leads
    'leads.title': 'Lead Management',
    'leads.searchPlaceholder': 'Search leads by name, email, or phone...',
    ...
    'leads.deleteConfirm': 'Delete Lead',
    'leads.statusNew': 'New',
    'leads.statusContacted': 'Contacted',
    'leads.statusQualified': 'Qualified',
    'leads.statusConverted': 'Converted',
    'leads.statusLost': 'Lost',
    'leads.noLeads': 'No leads found',
    'leads.noLeadsMessage': 'Get started by adding your first lead or importing from CSV',
    'leads.recordContact': 'Record Contact',
    'leads.contactRecorded': 'Contact recorded successfully',
    'leads.leadUpdated': 'Lead updated successfully',
    'leads.leadDeleted': 'Lead deleted successfully',

    // Lead Form
    'leadForm.title': 'Lead Information',
    'leadForm.fullName': 'Full Name',
    'leadForm.fullNamePlaceholder': 'Enter lead\'s full name',
    'leadForm.email': 'Email Address',
    'leadForm.emailPlaceholder': 'lead@example.com',
    'leadForm.phone': 'Phone Number',
    'leadForm.phonePlaceholder': '+1 (555) 123-4567',
    'leadForm.source': 'Lead Source',
    'leadForm.sourcePlaceholder': 'Select source',
    'leadForm.sourceWebsite': 'Website',
    'leadForm.sourceFacebook': 'Facebook',
    'leadForm.sourceGoogle': 'Google Ads',
    'leadForm.sourceReferral': 'Referral',
    'leadForm.sourceOther': 'Other',
    'leadForm.campaign': 'Campaign',
    'leadForm.campaignPlaceholder': 'Select campaign',
    'leadForm.notes': 'Notes',
    'leadForm.notesPlaceholder': 'Additional notes about this lead...',
    'leadForm.cancel': 'Cancel',
    'leadForm.save': 'Save Lead',
    'leadForm.saving': 'Saving...',

    // Campaigns
    'campaigns.title': 'Campaign Management',
    'campaigns.searchPlaceholder': 'Search campaigns...',
    'campaigns.addCampaign': 'Create Campaign',
    ...
    'campaigns.typeEmail': 'Email',
    'campaigns.typeSocial': 'Social Media',
    'campaigns.typePPC': 'Pay-per-Click',
    'campaigns.typeContent': 'Content Marketing',
    'campaigns.noCampaigns': 'No campaigns found',
    'campaigns.noCampaignsMessage': 'Create your first campaign to start tracking leads and conversions',

    // Campaign Form
    'campaignForm.title': 'Campaign Details',
    'campaignForm.name': 'Campaign Name',
    'campaignForm.namePlaceholder': 'Enter campaign name',
    'campaignForm.description': 'Description',
    'campaignForm.descriptionPlaceholder': 'Campaign description...',
    'campaignForm.type': 'Campaign Type',
    'campaignForm.budget': 'Budget ($)',
    'campaignForm.budgetPlaceholder': '1000',
    'campaignForm.startDate': 'Start Date',
    'campaignForm.endDate': 'End Date',
    'campaignForm.targetAudience': 'Target Audience',
    'campaignForm.targetPlaceholder': 'Describe your target audience...',
    'campaignForm.cancel': 'Cancel',
    'campaignForm.save': 'Save Campaign',
    'campaignForm.saving': 'Saving...',

    // Templates
    'templates.title': 'Email Templates',
    'templates.searchPlaceholder': 'Search templates...',
    'templates.addTemplate': 'Create Template',
    'templates.name': 'Template Name',
    'templates.subject': 'Subject Line',
    'templates.category': 'Category',
    'templates.lastModified': 'Last Modified',
    'templates.actions': 'Actions',
    'templates.preview': 'Preview',
    'templates.edit': 'Edit',
    'templates.duplicate': 'Duplicate',
    'templates.delete': 'Delete',
    'templates.categoryWelcome': 'Welcome',
    'templates.categoryFollowup': 'Follow-up',
    'templates.categoryPromo': 'Promotional',
    'templates.categoryNewsletter': 'Newsletter',
    'templates.noTemplates': 'No templates found',
    'templates.noTemplatesMessage': 'Create your first email template to streamline your communications',

    // Template Form
    'templateForm.title': 'Email Template',
    'templateForm.name': 'Template Name',
    'templateForm.namePlaceholder': 'Enter template name',
    'templateForm.subject': 'Email Subject',
    'templateForm.subjectPlaceholder': 'Enter email subject line',
    'templateForm.category': 'Category',
    'templateForm.content': 'Email Content',
    'templateForm.contentPlaceholder': 'Write your email content here...',
    'templateForm.variables': 'Available Variables',
    'templateForm.variablesDesc': 'Use these variables in your content: {{name}}, {{email}}, {{company}}',
    'templateForm.preview': 'Preview',
    'templateForm.cancel': 'Cancel',
    'templateForm.save': 'Save Template',
    'templateForm.saving': 'Saving...',

    // CSV Import
    'csvImport.title': 'Import from CSV',
    'csvImport.subtitle': 'Upload and import your leads from a CSV file',
    'csvImport.dragDrop': 'Drag and drop your CSV file here, or click to browse',
    'csvImport.supportedFormats': 'Supported formats: CSV files only',
    'csvImport.maxSize': 'Maximum file size: 10MB',
    'csvImport.requiredColumns': 'Required columns: name, email',
    'csvImport.optionalColumns': 'Optional columns: phone, source, campaign, notes',
    'csvImport.mapping': 'Column Mapping',
    'csvImport.selectColumn': 'Select column',
    'csvImport.preview': 'Preview',
    'csvImport.importing': 'Importing...',
    'csvImport.import': 'Import Leads',
    'csvImport.cancel': 'Cancel',
    'csvImport.success': 'Successfully imported {count} leads',
    'csvImport.error': 'Error importing CSV file',

    // Shopify CSV
    'shopifyCSV.title': 'Shopify CSV Tools',
    'shopifyCSV.subtitle': 'Import and export product data for Shopify',
    'shopifyCSV.importProducts': 'Import Products',
    'shopifyCSV.exportProducts': 'Export Products',
    'shopifyCSV.validateCSV': 'Validate CSV',
    'shopifyCSV.sampleDownload': 'Download Sample CSV',
    ...
    'errors.validation': 'Please fix the validation errors',
  ...
  he: {
    ...
    // E-commerce Section - Hebrew
    // Dashboard
    'ecommerce.dashboard.title': 'דשבורד מסחר אלקטרוני',
    'ecommerce.dashboard.overview': 'סקירה כללית',
    'ecommerce.dashboard.totalLeads': 'סה"כ לידים',
    'ecommerce.dashboard.activeLeads': 'לידים פעילים',
    'ecommerce.dashboard.convertedLeads': 'לידים שהומרו',
    'ecommerce.dashboard.conversionRate': 'שיעור המרה',
    'ecommerce.dashboard.totalCampaigns': 'סה"כ קמפיינים',
    'ecommerce.dashboard.activeCampaigns': 'קמפיינים פעילים',
    'ecommerce.dashboard.campaignPerformance': 'ביצועי קמפיינים',
    'ecommerce.dashboard.recentLeads': 'לידים אחרונים',
    'ecommerce.dashboard.topCampaigns': 'קמפיינים מובילים',
    'ecommerce.dashboard.quickActions': 'פעולות מהירות',
    'ecommerce.dashboard.createLead': 'צור ליד חדש',
    'ecommerce.dashboard.importCSV': 'ייבא CSV',
    'ecommerce.dashboard.newCampaign': 'קמפיין חדש',
    'ecommerce.dashboard.viewReports': 'הצג דוחות',

    // Leads
    'leads.title': 'ניהול לידים',
    'leads.searchPlaceholder': 'חיפוש לידים לפי שם, אימייל או טלפון...',
    'leads.addLead': 'הוסף ליד חדש',
    'leads.importLeads': 'ייבא לידים',
    'leads.exportLeads': 'ייצא לידים',
    'leads.bulkActions': 'פעולות מרובות',
    'leads.selectAll': 'בחר הכל',
    'leads.selected': 'נבחרו',
    'leads.markContacted': 'סמן כנוצר קשר',
    'leads.assignCampaign': 'הקצה לקמפיין',
    'leads.delete': 'מחק נבחרים',
    'leads.name': 'שם',
    'leads.email': 'אימייל',
    'leads.phone': 'טלפון',
    'leads.source': 'מקור',
    ...
    'leads.status': 'סטטוס',
    'leads.lastContact': 'קשר אחרון',
    'leads.createdAt': 'נוצר',
    'leads.actions': 'פעולות',
    'leads.view': 'צפה',
    'leads.edit': 'ערוך',
    'leads.contact': 'צור קשר',
    'leads.convert': 'המר',
    'leads.deleteConfirm': 'מחק ליד',
    'leads.statusNew': 'חדש',
    'leads.statusContacted': 'נוצר קשר',
    'leads.statusQualified': 'מתאים',
    'leads.statusConverted': 'הומר',
    'leads.statusLost': 'אבוד',
    'leads.noLeads': 'לא נמצאו לידים',
    'leads.noLeadsMessage': 'התחל בהוספת הליד הראשון שלך או ייבוא מקובץ CSV',
    'leads.recordContact': 'רשום קשר',
    'leads.contactRecorded': 'קשר נרשם בהצלחה',
    'leads.leadUpdated': 'ליד עודכן בהצלחה',
    'leads.leadDeleted': 'ליד נמחק בהצלחה',

    // Lead Form
    'leadForm.title': 'פרטי ליד',
    'leadForm.fullName': 'שם מלא',
    'leadForm.fullNamePlaceholder': 'הזן שם מלא של הליד',
    'leadForm.email': 'כתובת אימייל',
    'leadForm.emailPlaceholder': 'lead@example.com',
    'leadForm.phone': 'מספר טלפון',
    'leadForm.phonePlaceholder': '+972 50 123-4567',
    'leadForm.source': 'מקור הליד',
    'leadForm.sourcePlaceholder': 'בחר מקור',
    'leadForm.sourceWebsite': 'אתר אינטרנט',
    'leadForm.sourceFacebook': 'פייסבוק',
    'leadForm.sourceGoogle': 'גוגל אדס',
    'leadForm.sourceReferral': 'הפניה',
    'leadForm.sourceOther': 'אחר',
    'leadForm.campaign': 'קמפיין',
    'leadForm.campaignPlaceholder': 'בחר קמפיין',
    'leadForm.notes': 'הערות',
    'leadForm.notesPlaceholder': 'הערות נוספות על הליד הזה...',
    'leadForm.cancel': 'ביטול',
    'leadForm.save': 'שמור ליד',
    'leadForm.saving': 'שומר...',

    // Campaigns
    'campaigns.title': 'ניהול קמפיינים',
    'campaigns.searchPlaceholder': 'חיפוש קמפיינים...',
    'campaigns.addCampaign': 'צור קמפיין',
    'campaigns.name': 'שם קמפיין',
    'campaigns.type': 'סוג',
    'campaigns.status': 'סטטוס',
    'campaigns.budget': 'תקציב',
    'campaigns.spent': 'הוצא',
    'campaigns.leads': 'לידים',
    'campaigns.conversions': 'המרות',
    'campaigns.startDate': 'תאריך התחלה',
    'campaigns.endDate': 'תאריך סיום',
    'campaigns.actions': 'פעולות',
    'campaigns.view': 'צפה',
    'campaigns.edit': 'ערוך',
    'campaigns.pause': 'השהה',
    'campaigns.resume': 'המשך',
    'campaigns.delete': 'מחק',
    'campaigns.statusActive': 'פעיל',
    'campaigns.statusPaused': 'מושהה',
    'campaigns.statusCompleted': 'הושלם',
    'campaigns.statusDraft': 'טיוטה',
    'campaigns.typeEmail': 'אימייל',
    'campaigns.typeSocial': 'רשתות חברתיות',
    'campaigns.typePPC': 'תשלום לקליק',
    'campaigns.typeContent': 'שיווק תוכן',
    'campaigns.noCampaigns': 'לא נמצאו קמפיינים',
    'campaigns.noCampaignsMessage': 'צור את הקמפיין הראשון שלך כדי להתחיל לעקוב אחר לידים והמרות',

    // Campaign Form
    'campaignForm.title': 'פרטי קמפיין',
    'campaignForm.name': 'שם קמפיין',
    'campaignForm.namePlaceholder': 'הזן שם קמפיין',
    'campaignForm.description': 'תיאור',
    'campaignForm.descriptionPlaceholder': 'תיאור הקמפיין...',
    'campaignForm.type': 'סוג קמפיין',
    'campaignForm.budget': 'תקציב (₪)',
    'campaignForm.budgetPlaceholder': '1000',
    'campaignForm.startDate': 'תאריך התחלה',
    'campaignForm.endDate': 'תאריך סיום',
    'campaignForm.targetAudience': 'קהל יעד',
    'campaignForm.targetPlaceholder': 'תאר את קהל היעד שלך...',
    'campaignForm.cancel': 'ביטול',
    'campaignForm.save': 'שמור קמפיין',
    'campaignForm.saving': 'שומר...',

    // Templates
    'templates.title': 'תבניות אימייל',
    'templates.searchPlaceholder': 'חיפוש תבניות...',
    'templates.addTemplate': 'צור תבנית',
    'templates.name': 'שם תבנית',
    'templates.subject': 'נושא אימייל',
    'templates.category': 'קטגוריה',
    'templates.lastModified': 'עודכן לאחרונה',
    'templates.actions': 'פעולות',
    'templates.preview': 'תצוגה מקדימה',
    'templates.edit': 'ערוך',
    'templates.duplicate': 'שכפל',
    'templates.delete': 'מחק',
    'templates.categoryWelcome': 'ברוכים הבאים',
    'templates.categoryFollowup': 'מעקב',
    'templates.categoryPromo': 'קידום מכירות',
    'templates.categoryNewsletter': 'ניוזלטר',
    'templates.noTemplates': 'לא נמצאו תבניות',
    'templates.noTemplatesMessage': 'צור את תבנית האימייל הראשונה שלך כדי לייעל את התקשורת',

    // Template Form
    'templateForm.title': 'תבנית אימייל',
    'templateForm.name': 'שם תבנית',
    'templateForm.namePlaceholder': 'הזן שם תבנית',
    'templateForm.subject': 'נושא אימייל',
    'templateForm.subjectPlaceholder': 'הזן נושא אימייל',
    'templateForm.category': 'קטגוריה',
    'templateForm.content': 'תוכן אימייל',
    'templateForm.contentPlaceholder': 'כתוב את תוכן האימייל כאן...',
    'templateForm.variables': 'משתנים זמינים',
    'templateForm.variablesDesc': 'השתמש במשתנים האלה בתוכן: {{name}}, {{email}}, {{company}}',
    'templateForm.preview': 'תצוגה מקדימה',
    'templateForm.cancel': 'ביטול',
    'templateForm.save': 'שמור תבנית',
    'templateForm.saving': 'שומר...',

    // CSV Import
    'csvImport.title': 'ייבוא מקובץ CSV',
    'csvImport.subtitle': 'העלה וייבא את הלידים שלך מקובץ CSV',
    'csvImport.dragDrop': 'גרור והשלך את קובץ ה-CSV כאן, או לחץ לעיון',
    'csvImport.supportedFormats': 'פורמטים נתמכים: קבצי CSV בלבד',
    'csvImport.maxSize': 'גודל קובץ מקסימלי: 10MB',
    'csvImport.requiredColumns': 'עמודות חובה: name, email',
    'csvImport.optionalColumns': 'עמודות אופציונליות: phone, source, campaign, notes',
    'csvImport.mapping': 'מיפוי עמודות',
    'csvImport.selectColumn': 'בחר עמודה',
    'csvImport.preview': 'תצוגה מקדימה',
    'csvImport.importing': 'מייבא...',
    'csvImport.import': 'ייבא לידים',
    'csvImport.cancel': 'ביטול',
    'csvImport.success': 'יובאו בהצלחה {count} לידים',
    'csvImport.error': 'שגיאה בייבוא קובץ CSV',

    // Shopify CSV
    'shopifyCSV.title': 'כלי Shopify CSV',
    'shopifyCSV.subtitle': 'ייבא וייצא נתוני מוצרים עבור Shopify',
    'shopifyCSV.importProducts': 'ייבא מוצרים',
    'shopifyCSV.exportProducts': 'ייצא מוצרים',
    'shopifyCSV.validateCSV': 'אמת CSV',
    'shopifyCSV.sampleDownload': 'הורד קובץ דוגמה',
    ...
    // Error Messages
    'errors.required': 'שדה זה הוא חובה',
    'errors.email': 'נא הזן כתובת אימייל תקינה',
    'errors.phone': 'נא הזן מספר טלפון תקין',
    'errors.generic': 'משהו השתבש. נא נסה שוב.',
    'errors.network': 'שגיאת רשת. נא בדוק את החיבור שלך.',
    'errors.unauthorized': 'אין לך הרשאה לבצע פעולה זו',
    'errors.notFound': 'המשאב המבוקש לא נמצא',
    'errors.validation': 'נא תקן את שגיאות האימות',

    // Success Messages
    'success.saved': 'נשמר בהצלחה',
    'success.updated': 'עודכן בהצלחה',
    'success.deleted': 'נמחק בהצלחה',
    'success.imported': 'יובא בהצלחה',
    'success.exported': 'יוצא בהצלחה',
